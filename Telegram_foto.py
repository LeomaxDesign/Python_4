...
bot = telebot.TeleBot('1973265124:AAE_cHkFtFcasYrBtNBGr5F42adF375JvHD')


@bot.message_handler(commands=['start'])
def SendInfo(message):
    bot.send_message(message.chat.id, 'Привет! Введи запрос для поиска изображения:')
...
def SendMessage(message):
    bot.send_message(message.chat.id, "Ожидайте, я ищу для Вас картиночки!")
